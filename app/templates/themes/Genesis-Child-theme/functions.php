...
define( 'CHILD_TMPL_DIR', get_stylesheet_directory() );
...
function load_dev_styles_scripts() {
	// Theme styles
	wp_enqueue_style('themename', CHILD_TMPL_DIR . '/assets/dev/style.css', false, null, 'all');

	// Header Scripts
	wp_enqueue_script('header_scripts', CHILD_TMPL_DIR . '/assets/dev/header.js', array(), null, false);

	// Footer Scripts
	wp_enqueue_script('footer_scripts', CHILD_TMPL_DIR . '/assets/dev/footer.js', array('jquery'), null, true);

	// Single Scripts
	if ( is_single() ) {
		wp_enqueue_script('single_scripts', CHILD_TMPL_DIR . '/assets/dev/single.js', array('jquery'), null, true);
	}
}
...
function load_prod_styles_scripts() {
	// Theme styles
	wp_enqueue_style('themename', CHILD_TMPL_DIR . '/assets/dist/style.min.css', false, null, 'all');

	// Header Scripts
	wp_enqueue_script('header_scripts', CHILD_TMPL_DIR . '/assets/dist/header.min.js', array(), null, false);

	// Footer Scripts
	wp_enqueue_script('footer_scripts', CHILD_TMPL_DIR . '/assets/dist/footer.min.js', array('jquery'), null, true);

	// Single Scripts
	if ( is_single() ) {
		wp_enqueue_script('single_scripts', CHILD_TMPL_DIR . '/assets/dist/single.min.js', array('jquery'), null, true);
	}
}
